...
export async function generateMetadata({
  ...
  if (!article) return {};
  const url = `${BASE_URL}/${locale}/nail/knowledge/${slug}`;
  return {
    title: article.title,
    ...
    alternates: {
      canonical: url,
      languages: {
        "zh-TW": `${BASE_URL}/zh-TW/nail/knowledge/${slug}`,
        en: `${BASE_URL}/en/nail/knowledge/${slug}`,
      },
    },
    openGraph: {
      type: "article",
...
export default async function KnowledgeArticlePage({
  ...
  const url = `${BASE_URL}/${locale}/nail/knowledge/${slug}`;
  const sectionLabel = locale === "zh-TW" ? "美甲知識" : "Nail Knowledge";
    ...
    <>
      ...
      <BreadcrumbListJsonLd
        items={[
          ...
          { name: sectionLabel, url: `${BASE_URL}/${locale}/nail/knowledge` },
